...
<template>
  <article class="group/card relative min-h-80 min-w-[20rem] max-w-[20rem] myBorder border-border-color-strong overflow-hidden
    ...
    <img src="/templateProjectImg.png" alt="Project preview image" class="min-h-56 max-h-56 w-full object-cover rounded-xl group-hover/card:scale-[1.04] transition-scale duration-200"/>
    <ul class="absolute w-full px-2 opacity-0 group-hover:opacity-100 top-47 left-0
    ...
    <div class="flex flex-col w-full justify-center px-3 py-4 gap-4">
      <h4 class="text-2xl font-bold px-2 ">Project name</h4>
      ...
      <div class="flex flex-row flex-wrap gap-2 px-2 items-center">
        <Button class="group/liveDemoIco px-4 py-2 bg-primary-button hover:bg-primary-button-hover overflow-hidden gap-0 hover:gap-2">
